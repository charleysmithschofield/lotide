...
describe("#middle", () => {
  ...
  it("returns the middle element(s) for array with an odd number of elements, leaving the original array unchanged", () => {
  ...
  it("returns the middle elements for an array with an even number of elements, leaving the original array unchanged", () => {
